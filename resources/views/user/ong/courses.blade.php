        ...
        <div id="gridCourses" class="grid grid-cols-1 md:grid-cols-4 my-3">
            ...
            <div class="flex flex-col items-center justify-center gap-4 my-5">
                <div class="   max-w-full">
                    <p class="font-itim font-bold text-xl">Nome do Curso</p>
                </div>
                ...
                <div class="flex flex-col justify-center">
                    <div class="flex flex-col md:flex-row justify-center items-center ">
                        <div class="w-full md:w-1/2 flex flex-col items-center justify-center mt-5 md:mt-0 mx-5">
                            ...
                            <div class="mb-4 w-full">
                                <label for="Nome" class="block mb-1 text-lg font-medium text-black">Duração</label>
                                <input type="text" name="Nome" id="Nm"
                                    class="bg-white border border-customRed text-black text-lg rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    required />
                            </div>
                            <div class="mb-4 w-full">
                                <label for="Nome" class="block mb-1 text-lg font-medium text-black">Professor</label>
                                <input type="text" name="Nome" id="Nm"
                                    class="bg-white border border-customRed text-black text-lg rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    required />
                            </div>
                            <div class="mb-4 w-full">
                                <label for="Nome" class="block mb-1 text-lg font-medium text-black">Items para as
                                    aulas</label>
                                <input type="text" name="Nome" id="Nm"
                                    class="bg-white border border-customRed text-black text-lg rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    required />
                        ...
                        <div class="w-full md:w-1/2 flex flex-col items-center justify-center mt-5 md:mt-0">
                            <div class="mb-4 w-full">
                                <label for="Nome" class="block mb-1 text-lg font-medium text-black">Sobre o
                                    Curso</label>
                                <input type="text" name="Nome" id="Nm"
                                    class="bg-white border border-customRed text-black text-lg rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    required />
                            ...
                            <div class="mb-4 w-full">
                                <label for="Nome" class="block mb-1 text-lg font-medium text-black">Dias da
                                    Semana</label>
                                <input type="text" name="Nome" id="Nm"
                                    class="bg-white border border-customRed text-black text-lg rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    required />
                            ...
                            <div class="mb-4 w-full ">
                                <label for="Nome" class="block mb-1 text-lg font-medium text-black">Capa do
                                    curso</label>
                                <input type="file" name="Nome" id="Nm"
                                    class="bg-white border border-customRed text-black text-lg rounded-lg focus:ring-blue-300 focus:border-blue-300 block w-full p-2.5"
                                    required />
                            </div>
                        </div>
